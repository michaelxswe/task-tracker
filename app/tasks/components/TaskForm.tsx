    ...
    <div className="px-40">
      <form className="space-y-5" onSubmit={onSubmit}>
          ...
          <div className="space-y-2">
            ...
            <div>
              <Select.Root
                ...
                size="3"
                onValueChange={(value) =>
                  setValue("teamId", isNaN(parseInt(value)) ? null : parseInt(value))
                }
              >
                <Select.Trigger />
                <Select.Content position="popper">
        ...
        <div className="flex justify-center">
          <button
            className="w-28 h-10 rounded-md bg-[#134e4a] font-medium hover:bg-[#2a6a66] disabled:cursor-not-allowed disabled:opacity-50"
            disabled={submitting}
          >
            Submit
          </button>
